...
<?php require_once 'include/connexion.inc.php';  // Connexion_Base_de_donnée ?>
<!-- En_TETE -->
...
?>
 ...
 <?php echo nl2br(htmlspecialchars($info_com['com'])); ?><br/><br/>
 ...
 if (isset($_POST['envoyer']))
 {
    ...
    $req = "INSERT INTO commentaires(id, auteur,com, id_article ) VALUES('', '$auteur', '$comment', '$id_article')";
    mysql_query($req); 
 ?>
