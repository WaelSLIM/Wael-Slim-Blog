...
<div class="span8">
 ...
 <center><h2><font color="red"><?php echo $action_label ?> un article</font></h2>
   <form action="formulaire.php" method="post" enctype="multipart/form-data">
     ...
     Titre
     <br>
     <input type="text" name ="titre" value="<?php echo $data['titre'] ?>"></input>
     <br>
     <br> Texte
     <br>
     <textarea name ="texte" ><?php echo $data['contenu'] ?></textarea>
     <br>
     <br> Image
     <br>
     <input type="file" name="image" value="Choisissez un fichier"></input>
     <br>
     <br>
     Publicité;   &nbsp;&nbsp;&nbsp; <input type="checkbox" name="publie" <?php if ($data['publication']==1){ ?> checked="checked" <?php } ?> value="1" ></input>
     <br>
     <br>
     <input type="submit" name="<?php echo $action_label ?>" value="<?php echo $action_label ?>" class="btn btn-large btn-primary"></input>
